                ...
                <div class="tab-content p-4">
                  ...
                  <div id="menu1" class="tab-pane fade">
                        ...
                        <div class="card card-primary">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form id="form_validation" method="POST" action="{{route('tienchi')}}"  >
                            {{csrf_field()}}
                            <div class="card-body">
                              <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                          ...
                                          <input type="text" name="tien_chi" class="form-control" id="" placeholder="">
                                        </div>
                                        <div class="form-group col-md-12">
                            ...
                            <div class="card-footer">
                              <input type="submit" onclick="xacnhan(event)" name="chi_tieu" class="btn btn-info" value="Chi Tiêu">
                            </div>
                          </form>
                        </div>
                        <!-- /.card -->
                  ...
                  <div id="menu2" class="tab-pane fade">
                        ...
                        <div class="card card-primary">
                          ...
                          <form id="form_validation" method="POST" action="{{route('tienthu')}}"  >
                            ...
                            <div class="card-body">
                              <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                          <label for="">Số tiền</label>
                                          <input type="text" name="tien_thu" class="form-control" id="" placeholder="">
                                        </div>
                                        <div class="form-group col-md-12">
                                          <label for="">Ghi chú</label>
                                          <input type="text" name="ghi_chu" class="form-control" id="" placeholder="">
                            ...
                            <div class="card-footer">
                              <input type="submit" onclick="xacnhan(event)" class="btn btn-success" value="Nhận Tiền">
                            </div>
                          </form>
                        </div>
                        <!-- /.card -->
                  ...
                  <div id="menu3" class="tab-pane fade">
                        ...
                        <div class="card card-primary">
                          ...
                          <!-- /.card-header -->
                          <!-- form start -->
                          <form id="form_validation" method="POST" action="{{route('tienchomuon')}}" >
                            {{csrf_field()}}
                            <div class="card-body">
                              <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                          <label for="">Số tiền</label>
                                          <input type="text" name="tien_cho_muon" class="form-control" id="" placeholder="">
                                        </div>
                                        <div class="form-group col-md-12">
                                          <label for="">Ghi chú</label>
                                          <input type="text" name="ghi_chu" class="form-control" id="" placeholder="">
                            ...
                            <div class="card-footer">
                              <input type="submit" class="btn btn-danger" value="Cho Mượn">
                            </div>
                          </form>
                        </div>
                        <!-- /.card -->
